# Этап 16 — Project Manager

## Цель
Создать систему проектов, тегов и Smart Folders — ядро организации данных в CORE OS. После этого этапа пользователь может создавать проекты, назначать им теги, организовывать файлы, и переключаться между контекстами (Spaces).
