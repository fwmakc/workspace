...
- **Этап 18** — CRDT Engine (операционный журнал для сообщений).
- **Этап 19** — P2P Mesh (транспорт, обнаружение пиров).
- **Этап 21** — App Registry (core.messenger как system app).
...
### 22.5 Notifications
- **Local:** push-уведомление внутри CORE OS (этап 15, Overlay Layer) при новом сообщении.
