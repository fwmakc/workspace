...
## Цель
Создать полную документацию проекта: для пользователей, разработчиков, администраторов. После этого этапа любой может развернуть, использовать и расширять CORE OS без дополнительных вопросов.
