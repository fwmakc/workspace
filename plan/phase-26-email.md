...
## Цель
Создать подсистему электронной почты: IMAP/SMTP клиент, синхронизация, поиск, композер. После этого этапа пользователь может отправлять и получать письма через CORE OS.
