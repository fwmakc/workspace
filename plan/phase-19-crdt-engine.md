...
## Цель
Создать движок CRDT (Conflict-free Replicated Data Types) для автоматической синхронизации данных между устройствами без конфликтов. После этого этапа CORE OS умеет синхронизировать документы, настройки, и метаданные между локальными репликами.
